...
public class IMMLeaks {
    ...
    private static class ReferenceCleaner implements MessageQueue.IdleHandler, View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalFocusChangeListener {
        ...
        ReferenceCleaner(InputMethodManager inputMethodManager,
                         Field mHField,
    ...
    public static void fixFocusedViewLeak(Application application) {
        ...
        final InputMethodManager inputMethodManager = (InputMethodManager) application.getSystemService(
        ...
        application.registerActivityLifecycleCallbacks(new LifecycleCallbacksAdapter() {
            ...
            public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
                ReferenceCleaner cleaner = new ReferenceCleaner(inputMethodManager,
                                                                mHField,
                                                                mServedViewField,
